...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_script__WEBPACK_IMPORTED_MODULE_2__["burgerMenu"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
var burgerMenu = function burgerMenu() {
  ...
  var wrapperButton = document.querySelector('.header__toggle-wrapper');
  var header = document.querySelector('.header');
  var button = document.querySelector('.header__toggle');
  var headerButtons = header.querySelector('.header__button');
  var navNoJs = document.querySelector('.header__nav');
  var nav = header.querySelector('.header__nav');
  var content = document.querySelector('.article');
  var headerContent = document.querySelector('.header__content');
  var logoHeader = header.querySelector('.header__logo');
  var mainContent = document.querySelector('main');
  var burgerCross = document.querySelector('.visually-hidden--nofixed');
  var navLinks = nav.querySelectorAll('a');
  navNoJs.classList.add('header__nav--js');
  headerButtons.classList.remove('header__button--nojs');

  var cleanAfterburger = function cleanAfterburger() {
